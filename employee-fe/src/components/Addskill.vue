    ...
    <div class="container">
      <form v-on:submit="addSkillDB">
        ...
        <input
          ...
          name="fname"
          placeholder="ex: Java"
          v-model="newSkill.field.field_name"
        />
        ...
        <input
          ...
          v-model="newSkill.field.field_type"
        />
        ...
        <input
          ...
          id="experience"
          name="experience"
          placeholder="Months of Exp: ex '24'"
          v-model="newSkill.experience"
        />
...
export default {
  ...
  methods: {
    addSkillDB() {
      employeeAPI
        .addSkillByID(this.id, this.newSkill)
        .then(() => {
